...
<html>
<head>
<title>SIRYA FLOWERS SHOP</title>
<!-- for-mobile-apps -->
...
<body>
<!-- header -->
	<div style="position: abosulte; top: 0" class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p style="color: orange;">Temukan Bunga & Gift yang tepat untuk Moment Anda, BELANJA SEKARANG!</p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li style="color: white;"><i class="fa fa-phone" aria-hidden="true"></i style="color: white;">Hubungi Kami : 081223267529</li>
				</ul>
			</div>
			...
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						...
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 81223267529</li>
					</ul>
				</div>
